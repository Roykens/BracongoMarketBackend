angular.module("notesApp.actus.controllers", []).controller("ActuController", ["$scope", "$modal", "$log", "Event",
       ...
       $scope.toto = "Moi";
        $scope.afficherFenetre = function (item) {
            var modelInstance = $modal.open({
                ...
                controller: 'ActuFenetreController',
                controllerAs: 'depart',
                keyboard: true,
                backdrop: false,
                resolve: {
    ...
    }]).controller("ActuFenetreController", ["$log", "$scope", "$modalInstance", "element",
